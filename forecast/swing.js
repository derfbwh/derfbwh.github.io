...
let pollData = [
    { state: 'Florida', electoralVotes: 30, harris: 45, trump: 51.6, partisanLean: -.7396878 },
    ...
    { state: 'Michigan', electoralVotes: 15, harris: 48.7, trump: 47.4, partisanLean: -.1175974 },
    { state: 'Arizona', electoralVotes: 11, harris: 47, trump: 49.3, partisanLean: -.7171309 },
    { state: 'Georgia', electoralVotes: 16, harris: 47.7, trump: 49.1, partisanLean: -.7357549 },
    { state: 'Nevada', electoralVotes: 6, harris: 48.1, trump: 48.4, partisanLean: -.259005 },
    { state: 'North Carolina', electoralVotes: 15, harris: 47.6, trump: 49, partisanLean: -.4815506 }
]
